...
export default function IconO({ className = 'fill-yellow-light size-10' }: AppProps) {
  return (
    <svg className={className} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" role="img">
      <title>O Icon</title>
