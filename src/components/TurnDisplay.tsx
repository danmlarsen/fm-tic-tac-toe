...
export default function TurnDisplay() {
  ...
  return (
    <div className="justify-self-center flex gap-2 sm:gap-[0.8125rem] items-center justify-center w-24 h-10 sm:h-[3.25rem] sm:w-[8.75rem] sm:text-sm bg-navy-semidark rounded-sm sm:rounded-md shadow-inner-sm shadow-navy-darker text-silver-dark">
