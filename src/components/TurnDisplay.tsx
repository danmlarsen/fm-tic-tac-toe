...
export default function TurnDisplay() {
  ...
  return (
    <div className="justify-self-center flex items-center justify-center w-24 h-10 sm:h-[3.25rem] sm:w-[8.75rem] pb-1 sm:text-sm bg-navy-semidark rounded-sm sm:rounded-md shadow-inner-sm shadow-navy-darker text-silver-dark">
